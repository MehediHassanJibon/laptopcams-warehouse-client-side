    ...
    return (
        <div className='text-center px-3'>
            <div className='mt-5' style={{ height: '400px' }}>
                <h1 className='mb-5'>Laptopcams Warehouse</h1>
                <p><i className="fa-solid fa-location-dot"></i> Level-4, 34, Uttara, Dhaka</p>
                <p><Link className='text-dark' to=''><i className="fa-solid fa-envelope"></i> official: web@laptopcams-warehouse.com</Link></p>
